...
abstract class BaseTextThemeFactory implements TextThemeFactory {
  ...
  @override
  TextStyle get light => GoogleFonts.karla(
  ...
  @override
  TextStyle get regular =>  GoogleFonts.karla(
        color: ColorName.black,
        fontSize: 16,
  ...
  @override
  TextStyle get medium =>  GoogleFonts.karla(
        color: ColorName.black,
        fontSize: 16,
  ...
  @override
  TextStyle get semiBold =>  GoogleFonts.karla(
        color: ColorName.black,
        fontSize: 16,
  ...
  @override
  TextStyle get bold =>  GoogleFonts.karla(
        color: ColorName.black,
        fontSize: 16,
  ...
  @override TextStyle get headlineMedium => GoogleFonts.marcellus(
    fontWeight: FontWeight.w400,
    fontSize: 28,
  );
  @override TextStyle get headlineSmall => headlineMedium.copyWith(fontSize: 24);
